...
Waynote 是一个基于 **Jetpack Compose** 的 Android 应用，面向旅行者提供「**旅行记录 × 机票决策 × 票据归档 × 多币种记账**」的一体化体验，帮助用户在**出发前、旅途中、行程后**持续管理与回顾每次旅行。
...
- **出发前**：行程规划、机票决策辅助、预算预估  
- **旅途中**：轨迹/足迹记录、票据归档、随手记账  
- **行程后**：内容回顾、凭证整理与导出（用于报销/签证等）
...
- **票据与行程单管理**：标准化整理预订信息与凭证，支持按行程导出材料包（用于报销/签证等）。
